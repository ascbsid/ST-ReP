...
# Handle outliers according to Section 4.1 in the original paper : # [SDWPF: A Dataset for Spatial Dynamic Wind Power Forecasting Challenge at KDD Cup 2022] (http://arxiv.org/abs/2208.04360)
...
print(data.shape)
np.savez_compressed('SDWPF.npz',data=data)
